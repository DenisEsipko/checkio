 ...
 */
function sumLight(els, startWatching) {
    var count = 0;
    var temp;
...
console.log(sumLight([new Date(2015, 1, 12, 10, 0, 0),
    new Date(2015, 1, 12, 10, 0, 10)], new Date(2015, 1, 12, 10, 0, 0)), 10);
//
//
assert_1.strict.equal(sumLight([new Date(2015, 1, 12, 10, 0, 0), new Date(2015, 1, 12, 10, 0, 10)], new Date(2015, 1, 12, 10, 0, 5)), 5);
assert_1.strict.equal(sumLight([new Date(2015, 1, 12, 10, 0, 0), new Date(2015, 1, 12, 10, 0, 10)], new Date(2015, 1, 12, 10, 0, 0)), 10);
