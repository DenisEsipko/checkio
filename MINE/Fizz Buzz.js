...
assert_1.strict.equal(fizzBuzz(15), 'Fizz Buzz');
assert_1.strict.equal(fizzBuzz(6), 'Fizz');
assert_1.strict.equal(fizzBuzz(10), 'Buzz');
assert_1.strict.equal(fizzBuzz(7), '7');
