...
assert_1.strict.equal(checkPangram(('The quick brown fox jumps over the '
    + 'lazy dog.')), true);
assert_1.strict.equal(checkPangram('ABCDEF'), false);
assert_1.strict.equal(checkPangram('abcdefghijklmnopqrstuvwxyz'), true);
assert_1.strict.equal(checkPangram('ABCDEFGHIJKLMNOPQRSTUVWXYZ'), true);
assert_1.strict.equal(checkPangram('abcdefghijklmnopqrstuvwxy'), false);
assert_1.strict.equal(checkPangram(('Bored? Craving a pub quiz fix? Why, '
    + 'just come to the Royal Oak!')), true);
assert_1.strict.equal(checkPangram(("As quirky joke, chefs won't pay "
    + 'devil magic zebra tax.')), true);
assert_1.strict.equal(checkPangram(('Six big devils from Japan quickly '
