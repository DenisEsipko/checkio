...
assert_1.strict.equal(translate('hieeelalaooo'), 'hello');
assert_1.strict.equal(translate('hoooowe yyyooouuu duoooiiine'), 'how you doin');
assert_1.strict.equal(translate('aaa bo cy da eee fe'), 'a b c d e f');
assert_1.strict.equal(translate('sooooso aaaaaaaaa'), 'sos aaa');
